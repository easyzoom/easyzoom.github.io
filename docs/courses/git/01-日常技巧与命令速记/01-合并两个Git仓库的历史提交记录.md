...
1. 克隆后端项目仓库到本地（笔者没有在 git bash 中操作，而是在 cmd 中进行的）
   ...
   ```sh
   git clone https://gitee.com/easyzoom/eladminx.git
   cd eladminx
   ```

   ![202203252252923](/img/2022/03/25/202203252252923.png)

2. 将前端仓库作为后端仓库的远程仓库，起别名为 frontend（这个随便起）

   ```sh
   git remote add -f frontend https://gitee.com/easyzoom/eladminx-web.git
   ```

   ![202203252252926](/img/2022/03/25/202203252252926.png)
...
3. 将前端仓库的 master 分支（自己选择哪个分支）合并到后端仓库
   ...
   ![202203252252929](/img/2022/03/25/202203252252929.png)
   ...
   ![202203252252931](/img/2022/03/25/202203252252931.png)
