...
export const themeConfig: DefaultTheme.Config = {
  ...
  // 编辑链接配置
  editLink: {
    pattern: 'https://easyzoom.github.io/edit/main/docs/:path',
    text: '不妥之处，敬请雅正'
  },
  // 搜索配置（二选一）
  search: {
  ...
  // 导航栏右侧社交链接配置
  socialLinks: [
    { icon: 'github', link: 'https://easyzoom.github.io' },
    {
      icon: {
      ...
      link: 'https://gitee.com/easyzoom/easyzoom'
    },
  ],
  ...
  footerConfig: {
    ...
    icpRecordCode: '粤ICP备xxxxxxxxx号-2', // ICP备案号
    publicSecurityRecordCode: '粤公网安备1xxxxxxxxxx号', // 联网备案号
    copyright: `Copyright © 2024-${new Date().getFullYear()} EASYZOOM` // 版权信息
  }
}